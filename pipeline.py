...
def recluster(expt_path='', data=None, save=False, fig_pfx="", write_file=None, show=True, rescale = False, neighbors_key=None, harmonize=False, calc_leiden = True, calc_hvg = True, **kwargs):
